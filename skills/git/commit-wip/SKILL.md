...
| Test-only files (`*.test.ts`, `*.spec.ts`) | merge into their component group | n/a |
| Story files (`*.stories.tsx`) | merge into their component group | n/a |
...
my-other-repo  n/a                  n/a                            n/a    ✓ already clean
```
