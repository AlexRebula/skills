...
Replace any invocation of this skill with `/create-pr`. All functionality that was unique to this skill (LittleBranches OSS quality gate, stacking check, mergeable bar) has been merged into the generic `/create-pr` skill.
