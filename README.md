...
| [`/commit-wip`](./skills/engineering/commit-wip/SKILL.md) | Scan all local workspace repos for uncommitted changes and commit them to named branches — safe to run before any PR sweep or context switch. |
