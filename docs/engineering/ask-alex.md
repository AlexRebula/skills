...
The tracker-dependent routes (triage, `to-spec`, `to-tickets`, `implement`) assume `setup-engineering-skills` has already configured an issue tracker in the repo. The router will happily recommend them before that has happened.
