...
1. Skip the inline reply API calls for outdated threads (Steps 6 and 8) — they will return 404.
...
Non-outdated threads in the same PR still receive standard inline replies (Steps 6 and 8).
