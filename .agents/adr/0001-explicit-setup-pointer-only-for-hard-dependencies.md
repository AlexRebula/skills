...
- **Hard dependency** (`to-tickets`, `to-spec`, `triage`): include an explicit one-liner: _"… should have been provided to you; run `/setup-engineering-skills` if not."_ Without the mapping, output is wrong, not just fuzzy.
