...
Make `/setup-engineering-skills` friendlier and align the local-markdown tracker with the current spec.
...
Docs pages for `setup-engineering-skills` and `to-tickets` re-synced.
